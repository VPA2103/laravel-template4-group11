...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="{{ asset('assets/admin/bower_components/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet"
        type="text/css">
    @yield('linkcss')
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{route('admin.sanpham.add')  }}">Thêm Mới Sản Phẩm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Danh Mục<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Khuyến Mãi<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li class="active">
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Đánh giá<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
